...
import { FillValueSelect, FillValueSelectProps, FillValueOptions, NewFillValueSelect } from './FillValueSelect';
...
describe('NewFillValueSelect', () => {
  it('should change the fill value mode', async () => {
    render(<NewFillValueSelect {...props} />);
    expect(screen.getByText('Previous Value')).toBeInTheDocument();
