...
export function ResourceSelector(props: ResourceSelectorProps) {
  ...
  return (
    <InlineField label={props.label} labelWidth={props.labelWidth} tooltip={props.tooltip} hidden={props.hidden} htmlFor={props.id}>
...
export interface NewResourceSelectorProps extends SelectCommonProps<string> {
  value: string | null;
  dependencies?: DependencyList;
  id: string;
  ariaLabel: string;
...
export function NewResourceSelector(props: NewResourceSelectorProps) {
  const propsDependencies = props.dependencies;
  const propsOnChange = props.onChange;
